package cn.sample.api.test.entity;
...
public class Member implements Serializable {
	...
	/** level_id -- 现金分期信用等级id */
	@NotNull(message="test.Member.levelId.NotNull")
	private Short levelId;

	/** pdl_level_id -- PDL信用等级id */
	@NotNull(message="test.Member.pdlLevelId.NotNull")
	private Short pdlLevelId;

	/** realname -- 真实姓名 */
	@Length(max=50,message="test.Member.realname.Length")
	private String realname;

	/** mobileno -- 手机号 */
	@Length(max=50,message="test.Member.mobileno.Length")
	private String mobileno;

	/** loginpsw -- 登录密码 */
	@Length(max=100,message="test.Member.loginpsw.Length")
	private String loginpsw;

	/** bqs_open_id -- 会员的白骑士openid */
	@NotEmpty(message="test.Member.bqsOpenId.NotEmpty")
	@Length(max=100,message="test.Member.bqsOpenId.Length")
	private String bqsOpenId;

	/** tradingpsw -- 交易密码 */
	@Length(max=100,message="test.Member.tradingpsw.Length")
	private String tradingpsw;

	/** invitecode -- 邀请注册的邀请码 */
	@Length(max=10,message="test.Member.invitecode.Length")
	private String invitecode;

	/** my_invitecode -- 我的邀请码 */
	@Length(max=10,message="test.Member.myInvitecode.Length")
	private String myInvitecode;

	/** idcardno -- 身份证号 */
	@Length(max=50,message="test.Member.idcardno.Length")
	private String idcardno;

	/** longtimecity -- 长居城市 */
	@Length(max=50,message="test.Member.longtimecity.Length")
	private String longtimecity;

	/** detailaddr -- 详细地址 */
	@Length(max=200,message="test.Member.detailaddr.Length")
	private String detailaddr;

	/** leveleducation -- 文化程度 */
	@Length(max=20,message="test.Member.leveleducation.Length")
	private String leveleducation;

	/** familyincome -- 家庭月收入 */
	@NotNull(message="test.Member.familyincome.NotNull")
	private BigDecimal familyincome;

	/** unitnature -- 单位性质 */
	@Length(max=20,message="test.Member.unitnature.Length")
	private String unitnature;

	/** unitname -- 单位名称 */
	@Length(max=100,message="test.Member.unitname.Length")
	private String unitname;

	/** position -- 职务 */
	@Length(max=50,message="test.Member.position.Length")
	private String position;

	/** nation -- 民族 */
	@Length(max=10,message="test.Member.nation.Length")
	...
	@NotNull(message="test.Member.maritalstatus.NotNull")
	private Byte maritalstatus;

	/** sex -- 性别0男1女 */
	@NotNull(message="test.Member.sex.NotNull")
	private Byte sex;
	...
	/** origin_palce -- 籍贯 */
	@Length(max=20,message="test.Member.originPalce.Length")
	private String originPalce;

	/** is_enable -- 是否禁用0否1是（黑名单） */
	@NotNull(message="test.Member.isEnable.NotNull")
	private Byte isEnable;

	/** childrennumber -- 子女个数 */
	@NotNull(message="test.Member.childrennumber.NotNull")
	private Short childrennumber;

	/** mobilephonebrand -- 手机品牌 */
	@Length(max=20,message="test.Member.mobilephonebrand.Length")
	private String mobilephonebrand;

	/** linkman -- 联系人 */
	@Length(max=50,message="test.Member.linkman.Length")
	private String linkman;

	/** remark -- 备注 */
	@Length(max=30,message="test.Member.remark.Length")
	private String remark;

	/** linkphone -- 联系电话 */
	@Length(max=50,message="test.Member.linkphone.Length")
	private String linkphone;

	/** createdon -- 创建时间 */
	@NotNull(message="test.Member.createdon.NotNull")
